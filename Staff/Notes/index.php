...
<body>
    ...
    <div id="app">
        ...
        <div id="viewusers">
                ...
                <table id="audit">
                    <tr id="head"><th>First Name</th><th>LastName</th><th>Email</th><th>Phone</th><th><button class="Update" onclick="location.reload()">Update</button></th></tr>
                    <?php $users = new DisplayUsers(); $users->ViewStudentsAssigned(); ?>
                </table>
            </div>
        </div>
    </div>

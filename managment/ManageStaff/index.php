    ...
    <div id="app">
        ...
        <div id="content">
            <div id="viewusers">
                <h1>Manage Staff</h1>
                <table id="audit">
                    <tr id="head"><th>First Name</th><th>LastName</th><th>Email</th><th>Title</th><th>Active</th><th><button class="Update" onclick="location.reload()">Update</button></th><th><a href="/managment/ManageStaff/Addstaff/"><button class="Update">AddUser<img alt="Adduser" src="/static/images/user-plus-solid.svg"></button></a></th></tr>
                    <?php $users = new DisplayUsers(); $users->DisplayUsers("Staff"); ?>
                </table>
            </div>
        </div>
    </div>

    ...
    <div id="app">
        ...
        <div id="content">
            <div id="viewusers">
                <h1>Manage Tutors</h1>
                <table id="audit">
                    <tr id="head"><th>First Name</th><th>LastName</th><th>Email</th><th>Title</th><th>Active</th><th><button class="Update" onclick="location.reload()">Update</button></th></tr>
                    <?php $users = new DisplayUsers(); $users->DisplayUsers("Tutors"); ?>
                </table>
            </div>
        </div>
    </div>

...
<body>
    <?php
        ...
        if(!$perms->HasPermByPermNameFromArray(array("H.Tutor","S.Tutor","TutorP"))){
    ...
    <div id="app">
        ...
        <div id="content">
            <div id="viewusers">
                ...
                <table id="audit">
                    <tr id="head"><th>First Name</th><th>LastName</th><th>Email</th><th>Phone</th><th>Active</th><th><button class="Update" onclick="location.reload()">Update</button></th><th><a href="/managment/ManageStudents/Addstudent/"><button class="Update">AddUser<img alt="Adduser" src="/static/images/user-plus-solid.svg"></button></a></th></tr>
                    <?php $users = new DisplayUsers(); $users->DisplayUsers("Student"); ?>
                </table>
            </div>
        </div>
    </div>
